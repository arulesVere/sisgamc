        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">LISTA CARPETAS / FINANZAS</h4>
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                      ...
                      >
                        ...
                        <tbody>
                        @foreach($querybyfinanzas as $qbf)
                          <tr>
                            ...
                            <td>{{$qbf->estante}}</td> 
                            <td>
                              <a href="{{route('listfile',$qbf->idfolder)}}" data-toggle="modal" data-target="" class="btn btn-primary btn-sm"><i class="mdi mdi-eye"></i></a>
                              <a href="/Finanzas/{{$qbf->idfolder}}/edit" class="btn btn-secondary btn-sm"><i class="mdi mdi-pencil"></i></a>
