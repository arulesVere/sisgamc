                    ...
                    >
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$q->detalle}}</td>
                          @if($q->estado==0)
                          <td><p class="text-warning">INACTIVO</p></td>
                          @else
                          ...
                          <td>
                            ...
                            <a href="/Cargo/{{$q->idcargo}}/edit" class="btn btn-secondary btn-sm"><i class="mdi mdi-pencil"></i></a>
                            <a href="/Cargo/{{$q->idcargo}}/delete" data-bs-toggle="modal" data-bs-target="#deleteModal{{$q->idcargo}}" class="btn btn-danger btn-sm"><i class="mdi mdi-delete"></i></a>
                          </td>
                        </tr>                   
