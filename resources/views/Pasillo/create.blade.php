        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="card">
                <form class="form-horizontal" action="/Pasillo" method="Post">
                    @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input
                          ...
                          class="form-control"
                          id="fname"
                          placeholder="NOMBRE DE PASILLO" name="txtpasillo"
                        />
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      >
                      <div class="col-sm-4">
                        <textarea class="form-control" rows="3" cols="40" name="txtdetalle"></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label
