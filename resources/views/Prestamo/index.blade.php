        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">LISTA PRESTAMOS</h4>
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tbody>
                        @foreach($queryprestamo as $qp)
                        <tr>
                          <td>{{$loop->iteration}}</td>
                          <td>{{$qp->codigofolder}}</td>
                          <td>{{$qp->fechaprestamo}}</td>
                          <td>{{$qp->fechadevolucion}}</td>
                          <td>{{$qp->estante}}</td>
                          <td>{{$qp->motivo}}</td>
                          <td>{{$qp->aquien}}</td>
                          @if($qp->estado==2)
                          ...
                          <td>
                            ...
                            <!-- <a href="/Prestamo/{{$qp->idprestamo}}/edit" class="btn btn-secondary btn-sm"><i class="mdi mdi-pencil"></i></a> -->
                            <a href="/Prestamo/{{$qp->idfolder}}/edit" data-bs-toggle="modal" data-bs-target="#deleteModal{{$qp->idfolder}}" class="btn btn-info btn-sm"><i class="mdi mdi-debug-step-over"></i></a>
                          </td>
                        </tr>                   
